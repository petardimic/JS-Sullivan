...
/*=========================================================================================
 ...
 Este modulo se encarga de subir el archvio al servidor, el maximo tama? de archivo permitido
 para subir depende de la configuracion del WebServer, por ejemplo en Apache el maximo por
 defecto es de 2MB.
 -------------------------------------------------------
 HISTORICO:
 Release 1.0 - May.20 / 2006 - DiG
 Esta aplicacion nace tiempo atras aproximadamente en el a? 2004 como un beta pero que
...
echo "<script>alert('ERROR NO FILE');;history.back();</script>";
}else{
